...
export class ConfigManager {
    static CONFIG_FILE = ".gemini-refiner.json";
    ...
    static getPredictiveMandates() {
        ...
        for (const kw of keywords) {
            ...
            if (count >= 3) {
                if (kw === "test")
                    predictive.push("Predictive: You've asked for tests in 30% of recent prompts. Ensure comprehensive testing.");
                if (kw === "security")
                    predictive.push("Predictive: Security is a recurring theme. Apply OWASP principles strictly.");
                if (kw === "doc")
                    predictive.push("Predictive: Frequent documentation requests detected. Ensure JSDoc/README updates.");
            }
        }
        return predictive;
    }
