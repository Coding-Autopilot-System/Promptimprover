...
export class PromptOptimizer {
   ...
   */
  async optimize(originalPrompt: string, ctx: ProjectContext, iterations: number = 2): Promise<string> {
...
Lessons: ${JSON.stringify(ctx.predictiveLessons?.map((l: any) => l.summary) || [])}
